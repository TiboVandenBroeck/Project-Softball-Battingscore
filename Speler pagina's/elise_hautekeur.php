...
<head>
    ...
    <script src="../Scripts/elise_hautekeur_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Elise Hautekeur</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,343</div>
        <div class="grid-item">09/01/1998</div>
        ...
        <div class="grid-item">OPS = 0,769</div>
        
        <div class="grid-item">Lid van: 2014</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,406</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,363</div>
