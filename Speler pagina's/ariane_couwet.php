...
<head>
    ...
    <script src="../Scripts/ariane_couwet_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Ariane Couwet</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,444</div>
        <div class="grid-item">15/06/2002</div>
        ...
        <div class="grid-item">OPS = 1,110</div>
        
        <div class="grid-item">Lid van: 2021</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,666</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,444</div>
