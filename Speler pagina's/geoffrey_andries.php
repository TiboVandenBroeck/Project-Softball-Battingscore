...
<head>
    ...
    <script src="../Scripts/geoffrey_andries_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Geoffrey Andries</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,789</div>
        <div class="grid-item">28/04/1989</div>
        ...
        <div class="grid-item">OPS = 2,473</div>
        
        <div class="grid-item">Lid van: 2010</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 1,684</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,789</div>
