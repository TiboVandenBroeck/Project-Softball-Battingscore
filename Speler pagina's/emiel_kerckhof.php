...
<head>
    ...
    <script src="../Scripts/emiel_kerckhof_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Emiel Kerckhof</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,538</div>
        <div class="grid-item">07/07/2002</div>
        ...
        <div class="grid-item">OPS = 1,362</div>
        
        <div class="grid-item">Lid van: 2016</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,807</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,555</div>
