...
<head>
    ...
    <script src="../Scripts/ruben_ravestyn_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        ...
        <div class="grid-item">OPS = 1,713</div>
        
        <div class="grid-item">Lid van: 2012</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 1,142</div>
