...
<head>
    ...
    <script src="../Scripts/josephine_berten_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Josephine Berten</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,483</div>
        <div class="grid-item">30/01/2001</div>
        ...
        <div class="grid-item">OPS = 1,031</div>
        
        <div class="grid-item">Lid van: 2015</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,548</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,483</div>
