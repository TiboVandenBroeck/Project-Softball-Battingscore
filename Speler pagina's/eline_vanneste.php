...
<head>
    ...
    <script src="../Scripts/eline_vanneste_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Eline Vanneste</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,315</div>
        <div class="grid-item">27/10/2000</div>
        ...
        <div class="grid-item">OPS = 0,630</div>
        
        <div class="grid-item">Lid van: 2022</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,315</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,315</div>      
    </div>
