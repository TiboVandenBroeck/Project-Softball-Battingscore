...
<head>
    ...
    <script src="../Scripts/adhemar_couwet_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Adhemar Couwet</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,411</div>
        <div class="grid-item">17/03/2005</div>
        ...
        <div class="grid-item">OPS = 2,058</div>
        
        <div class="grid-item">Lid van: 2015</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,588</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 1,470</div>
    </div>
