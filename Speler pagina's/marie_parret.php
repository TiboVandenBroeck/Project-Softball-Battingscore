...
<head>
    ...
    <script src="../Scripts/marie_parret_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Marie Parret</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,260</div>
        <div class="grid-item">01/05/2001</div>
        ...
        <div class="grid-item">OPS = 0,781</div>
        
        <div class="grid-item">Lid van: 2016</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,521</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,260</div>
