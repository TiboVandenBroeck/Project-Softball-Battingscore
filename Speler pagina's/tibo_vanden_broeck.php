...
<head>
    ...
    <script src="../Scripts/tibo_vanden_broeck_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Tibo Vanden Broeck</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,571</div>
        <div class="grid-item">10/08/2005</div>
        ...
        <div class="grid-item">OPS = 1,475</div>
        
        <div class="grid-item">Lid van: 2014</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,904</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,571</div>
