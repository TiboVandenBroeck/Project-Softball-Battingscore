...
<head>
    ...
    <script src="../Scripts/julie_kerckhof_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Julie Kerckhof</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,437</div>
        <div class="grid-item">06/12/1998</div>
        ...
        <div class="grid-item">OPS = 1,312</div>
        
        <div class="grid-item">Lid van: 2013</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0,875</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,437</div>
