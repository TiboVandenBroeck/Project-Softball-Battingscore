...
<head>
    ...
    <script src="../Scripts/luka_decorte_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Luka Decorte</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0,580</div>
        <div class="grid-item">18/07/2001</div>
        ...
        <div class="grid-item">OPS = 3,515</div>
        
        <div class="grid-item">Lid van: 2014</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 2,935</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,580</div>
