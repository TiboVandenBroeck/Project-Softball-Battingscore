...
<head>
    ...
    <script src="../Scripts/kaily_blanckaert_chart.js"></script>
</head>
<body>
    ...
    <div class="grid-container">
        <div class="grid-item">Kaily Blanckaert</div>
        <div class="grid-item">Seizoen Statisiek:</div>
        
        <div class="grid-item">AVG = 0.320</div>
        <div class="grid-item">04/10/2005</div>
        ...
        <div class="grid-item">OPS = 0,706</div>
        
        <div class="grid-item">Lid van: 2013</div>
        <div class="grid-item">Gold</div>
        
        <div class="grid-item">SLG = 0.360</div>
        
        <div class="grid-item"></div>
        
        <div class="grid-item"></div>
        <div class="grid-item">OBP = 0,346</div>
