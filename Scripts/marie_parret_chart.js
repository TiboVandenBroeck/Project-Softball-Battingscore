...
data.addRows([
    ['Heist Afterburners Thuis\n30/03/2024', 0.25, 0.5, 0.375, 0.875],
    ['Borgerhout Squirels Thuis\n01/04/2024', 0.5, 0.5, 0.5, 1],
    ['Frontliners OG Uit\n13/04/2024', 0.166, 0.166, 0.166, 0.333],
    ['Leuven Twins Uit\n20/04/2024', 0.285, 0.428, 0.428, 0.857],
]);

var options = {
    title: 'Batting Stats Marie Parret',
    curveType: 'function',
